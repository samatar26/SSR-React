...
_reactDom2.default.hydrate(_react2.default.createElement(_app2.default, null), document.getElementById('page'));
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(8),B=__webpack_require__(2),C=__webpack_require__(0),ba=__webpack_require__(9),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ia=__webpack_require__(13),D=__webpack_require__(4);
...
var BaseBrowserTag = function () {
  ...
  BaseBrowserTag.prototype.toReactElement = function toReactElement() {
    throw new Error(undefined !== 'production' ? "BrowserTag doesn't implement toReactElement!" : '');
  };

  BaseBrowserTag.prototype.clone = function clone() {
    throw new Error(undefined !== 'production' ? 'BrowserTag cannot be cloned!' : '');
  };
  ...
  BrowserTag = function (_BaseBrowserTag) {
    ...
    SpeedyBrowserTag.prototype.replaceElement = function replaceElement() {
      ...
      if (!this.el.parentNode) {
        throw new Error(undefined !== 'production' ? "Trying to replace an element that wasn't mounted!" : '');
      }
...
var BrowserStyleSheet = {
  create: function create() {
    ...
    var tagConstructor = function tagConstructor(isLocal) {
      ...
      if (!document.head) {
        throw new Error(undefined !== 'production' ? 'Missing document <head>' : '');
      }
...
var ServerTag = function () {
  function ServerTag(isLocal) {
    ...
    this.isProduction = undefined === 'production';
    this.components = {};
    this.size = 0;
    this.names = [];
  }
  ...
  ServerTag.prototype.addComponent = function addComponent(componentId) {
    if (this.components[componentId]) {
      throw new Error(undefined !== 'production' ? 'Trying to add Component \'' + componentId + '\' twice!' : '');
    }
  ...
  ServerTag.prototype.inject = function inject(componentId, css, name) {
    ...
    if (!comp) {
      throw new Error(undefined !== 'production' ? 'Must add a new component before you can inject css into it' : '');
    }
...
var ServerStyleSheet = function () {
  ...
  ServerStyleSheet.prototype.collectStyles = function collectStyles(children) {
    if (this.closed) {
      throw new Error(undefined !== 'production' ? "Can't collect styles once you've called getStyleTags!" : '');
    }
  ...
  ServerStyleSheet.prototype.interleaveWithNodeStream = function interleaveWithNodeStream(readableStream) {
    {
      throw new Error(undefined !== 'production' ? 'streaming only works in Node.js, please do not try to call this method in the browser' : '');
    }
  };
